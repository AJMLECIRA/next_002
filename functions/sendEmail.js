...
// Export a Cloud Function triggered by HTTP request
exports.processEmail = functions.https.onRequest((request, response) => {
  ...
  cors(request, response, async () => {
    ...
    if (!request) {
      ...
      response
        .status(500)
        .send({ error: 'Internal server error. Request object is undefined.' });
      return;
    }
